...
def auto_resize_treeview(tree: ttk.Treeview, fractions=None, min_px=60):
    """Redimensiona columnas del Treeview proporcionalmente al ancho disponible."""
    cols = tree["columns"]
    if not cols:
        return
...
def load_optiondb_defaults(root: tk.Tk):
    """Carga configuraciones por defecto para mejorar apariencia."""
